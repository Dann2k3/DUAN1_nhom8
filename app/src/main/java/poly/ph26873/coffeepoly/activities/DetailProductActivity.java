...
//            imv_detail_product_avatar.setImageResource(product.getImage());
            Glide.with(DetailProductActivity.this).load(product.getImage()).apply(new RequestOptions().transform(new RoundedCorners(45)).transform(new CenterCrop())).into(imv_detail_product_avatar);
