...
//        xoaFav();
    ...
    private void pushImage() {
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference reference = database.getReference("coffee-poly/product/1/image");
        reference.setValue(R.drawable.prd_cps, (error, ref) -> Log.d(TAG, "pushImage: thanh cong"));
    }
